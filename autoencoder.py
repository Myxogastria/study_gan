...
feature_unbounded_flattened = lyr.Dense(n_feature*n_class, name='feature_dense', activation='relu')(filtered_flattened)
...
feature_bounded = lyr.Lambda(lambda x: x/(x+1), name='limit')(feature_unbounded)
...
for i_feature in range(n_feature):
    for i_class in range(n_class):
        ...
        plt.imshow(generator.predict(feature_matrix)[0, :, :, 0], clim=clim)
